...
sudo apt install -y python3 python3-pip python3-venv zip libgtk-3-dev libwebkit2gtk-4.0-dev libgl1-mesa-dev libglu1-mesa-dev freeglut3-dev libosmesa6-dev libpython3-dev
